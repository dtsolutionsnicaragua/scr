...
public class FrmRepuesto extends JPanel {
	...
	private Parte repuesto;
	private JLabel lblNmeroParte;
	...
	public void cargarListaRepuesto(){
		dataTable.DAOModelo.ConsultaSQL =  "SELECT idparte AS ID,DATE_FORMAT( fecha, '%d/%m/%Y' ) as Fecha,numero AS Codigo, Nombre ,activo as Vigente FROM parte";
			...
			internalToolBarMenu.getBtnGuardar().addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					if(verificarRequerimientos()){
						...
						repuesto.setFecha(new Date(dcFecha.getDate().getTime()));
						repuesto.setNumero(txtCodigo.getText());
						repuesto.setNombre(txtNombre.getText());
						repuesto.setActivo(cbxActivo.isSelected());
						
						if(txtId.getText().isEmpty()){
							if( BDParte.guardar(repuesto)){
								JOptionPane.showMessageDialog(null, "Registro Guardado Satisfactoriamente");
							}
						}else{	
							repuesto.setIdparte(Integer.parseInt(txtId.getText()));
							if(BDParte.Modificar(repuesto)){
	...
	public JPanel getPanelGeneral() {
		if (panelGeneral == null) {
			...
			panelGeneral.setForeground(Color.WHITE);
			...
			gbl_panelGeneral.columnWidths = new int[]{80, 10, 150, 150, 100, 0};
			gbl_panelGeneral.rowHeights = new int[]{40, 40, 0, 30, 40, 0};
			...
			GridBagConstraints gbc_lblNmeroParte = new GridBagConstraints();
			gbc_lblNmeroParte.anchor = GridBagConstraints.WEST;
			gbc_lblNmeroParte.insets = new Insets(10, 10, 5, 5);
			gbc_lblNmeroParte.gridx = 0;
			gbc_lblNmeroParte.gridy = 2;
			panelGeneral.add(getLblNmeroParte(), gbc_lblNmeroParte);
			GridBagConstraints gbc_label_1 = new GridBagConstraints();
			gbc_label_1.insets = new Insets(0, 0, 5, 5);
			gbc_label_1.anchor = GridBagConstraints.EAST;
			gbc_label_1.gridx = 1;
			gbc_label_1.gridy = 2;
			panelGeneral.add(getLabel_1(), gbc_label_1);
			GridBagConstraints gbc_txtCodigo = new GridBagConstraints();
			gbc_txtCodigo.gridwidth = 2;
			gbc_txtCodigo.insets = new Insets(10, 0, 5, 5);
			gbc_txtCodigo.fill = GridBagConstraints.HORIZONTAL;
			gbc_txtCodigo.gridx = 2;
			gbc_txtCodigo.gridy = 2;
			panelGeneral.add(getTxtCodigo(), gbc_txtCodigo);
	...
	public JDataTable getDataTable() {
		if (dataTable == null) {
			...
			dataTable._setAnchoColumna(2, 150);
			dataTable._setAnchoColumna(3, 350);
			...
			rowSelMod.addListSelectionListener(new ListSelectionListener() {
				public void valueChanged(ListSelectionEvent evt) {
					...
					txtCodigo.setText(dataTable.getValueAt(dataTable.getSelectedRow(), 2).toString());
	...
	public JLabel getLblNmeroParte() {
		if (lblNmeroParte == null) {
			lblNmeroParte = new JLabel("Codigo");
			lblNmeroParte.setForeground(Color.WHITE);
			lblNmeroParte.setFont(new Font("Segoe UI Semibold", Font.BOLD, 14));
		}
		return lblNmeroParte;
	}
	public JTextField getTxtCodigo() {
		if (txtCodigo == null) {
			txtCodigo = new JTextField();
			txtCodigo.addFocusListener(getEventListener());
	...
	public JLabel getLabel_1() {
		if (label_1 == null) {
			label_1 = new JLabel("*");
			label_1.setToolTipText("El campo codigo es obligatorio");
